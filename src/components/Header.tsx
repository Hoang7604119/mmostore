        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-3 w-72 sm:w-80 bg-gradient-to-br from-white via-blue-50/30 to-white backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100/50 py-4 z-[70] animate-in slide-in-from-top-2 duration-300 max-h-[85vh] overflow-y-auto">
