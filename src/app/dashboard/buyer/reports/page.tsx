...
import { AlertTriangle, ArrowLeft, Clock, CheckCircle, XCircle, Eye, FileText, DollarSign, Search, Filter, User, Package, Calendar, Tag } from 'lucide-react'
...
export default function BuyerReportsPage() {
  ...
  const handleViewReport = (reportId: string) => {
    router.push(`/dashboard/buyer/reports/${reportId}`)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Báo cáo của tôi</h1>
          <p className="text-gray-600">Xem và theo dõi các báo cáo bạn đã gửi</p>
        </div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div className="flex items-center text-sm text-gray-600">
                              ...
                              <span>Người bán: {report.sellerId.username}</span>
                            </div>
                            <div className="flex items-center text-sm text-gray-600">
