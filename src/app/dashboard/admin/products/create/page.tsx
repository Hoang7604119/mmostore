...
export default function CreateProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.type || !formData.title || !formData.pricePerUnit || !formData.quantity || !formData.sellerId) {
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 mb-8 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-white">Tạo Sản Phẩm (Admin)</h1>
                  <p className="text-blue-100 mt-1">Tạo sản phẩm cho seller và tự động duyệt</p>
                </div>
              </div>
            </div>
